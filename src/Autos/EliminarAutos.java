...
String id_autos;
    ...
    ControlAutosConsulta bash = new ControlAutosConsulta();  
    /**
...
try{
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ELIMINAR AUTO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
       bash.EliminarAuto(id_autos);
       dispose();
        EliminarAutos.main(null);
       bash.CargarEliminarAutos();
       txtBuscar.setText("");
      // jTextArea1.setText("");
    ...
    private void TableAutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableAutosMouseClicked
        int fila = TableAutos.rowAtPoint(evt.getPoint());

        id_autos=(TableAutos.getValueAt(fila, 0).toString());
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        ...
        cc.buscarEliminarAuto(parametroBusqueda);
                                                                                           int[] anchos = {35, 150, 300, 150, 150, 150, 150,150};
        for (int i = 0; i < TableAutos.getColumnCount(); i++) {
            TableAutos.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);}
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     ...
     private void llamarAutos() {
        ...
        // llamada de datos
        ControlAutosConsulta load = new ControlAutosConsulta();
        load.CargarEliminarAutos();
                                                                                           int[] anchos = {35, 150, 300, 150, 150, 150, 150,150};
        for (int i = 0; i < TableAutos.getColumnCount(); i++) {
            TableAutos.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);}
